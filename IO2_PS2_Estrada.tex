...
\NormalTok{figure2 =}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(data, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{TPOP)) +}\StringTok{ }\KeywordTok{geom_bar}\NormalTok{() +}
...
\includegraphics{IO2_PS2_Estrada_files/figure-latex/unnamed-chunk-1-1.pdf}
